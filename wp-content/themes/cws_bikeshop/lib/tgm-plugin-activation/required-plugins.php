...
add_action( 'tgmpa_register', 'multi_theme_register_required_plugins' );
 ...
 */
function multi_theme_register_required_plugins() {
    /*
    ...
    $plugins = array(
        ...
        /*array(
            ...
            'source'             => get_stylesheet_directory() . '/lib/plugins/cmb2.zip', // The plugin source.
