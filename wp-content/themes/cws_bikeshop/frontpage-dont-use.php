                        ...
                        <div class="shell section-top-66 section-bottom-66 section-lg-bottom-0">
                            <div class="range range-xs-center range-xs-middle">
                                <div class="col-sm-10 col-md-11 col-lg-4 text-sm-left section-lg-bottom-85">
                                    <h1><?= $lifestyleTagline; ?></h1>
                                    <h5 class="text-regular offset-top-50"><?= $lifestyleText; ?></h5><a href="<?= $lifestyleUrl; ?>" class="btn btn-primary offset-top-10"><?= $lifestyleCta; ?></a>
                                </div>
